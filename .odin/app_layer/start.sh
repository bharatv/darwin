...
case "${ODIN_DEPLOYMENT_TYPE}" in
  *container*|*k8s*)
    exec uvicorn mlflow_app_layer.main:app --host 0.0.0.0 --port 8080
    ;;
  *)
    nohup uvicorn mlflow_app_layer.main:app --host 0.0.0.0 --port 8080 > /opt/logs/app_layer.log 2>&1 &
